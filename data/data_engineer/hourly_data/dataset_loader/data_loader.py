...
def get_dataloader(
    ...
    **kwargs
    ...
    # include_current 参数名适配
    if include_current is not None:
        include_current = include_current
    else:
        include_current = config.INCLUDE_CURRENT_HOUR
...
def get_train_dataloader(
    ...
    **kwargs
    ...
    """快速创建训练集 DataLoader"""
    return get_dataloader(split='train', batch_size=batch_size, shuffle=shuffle, **kwargs)
...
def get_test_dataloader(
    ...
    **kwargs
    ...
    """快速创建测试集 DataLoader"""
    return get_dataloader(split='test', batch_size=batch_size, shuffle=shuffle, **kwargs)
...
def get_dataloaders(
    ...
    **kwargs
    ...
    train_loader = get_train_dataloader(batch_size=batch_size, shuffle=shuffle_train, **kwargs)
    test_loader = get_test_dataloader(batch_size=batch_size, shuffle=shuffle_test, **kwargs)
...
class DataLoaderFactory:
    ...
    def create_train_loader(self, shuffle: bool = True, drop_last: bool = False, **loader_kwargs) -> DataLoader:
        if self._train_dataset is None:
            self._train_dataset = WeatherSequenceDataset(
                data_path=config.TRAIN_DATA_PATH, **self.dataset_kwargs)
        return DataLoader(
    ...
    def create_test_loader(self, shuffle: bool = False, drop_last: bool = False, **loader_kwargs) -> DataLoader:
        if self._test_dataset is None:
            self._test_dataset = WeatherSequenceDataset(
                data_path=config.TEST_DATA_PATH, **self.dataset_kwargs)
        return DataLoader(
    ...
    def create_loaders(self, shuffle_train: bool = True, shuffle_test: bool = False, **loader_kwargs) -> Dict[str, DataLoader]:
        return {
